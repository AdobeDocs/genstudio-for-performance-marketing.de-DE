...
Die [!DNL Insights] Ansicht _[!UICONTROL Kampagnen]_ zeigt eine Liste der Kampagnen für das verbundene Kanal-Werbekonto an.

{{connect-insights}}

Die _[!UICONTROL Kampagnen]_-Tabelle ist mithilfe der kanalbasierten Anzeigenkampagne organisiert. Klicken Sie auf das Symbol Einstellungen (Zahnrad) oberhalb der rechten Seite der Tabelle, um zwischen den sichtbaren Spalten umzuschalten.
