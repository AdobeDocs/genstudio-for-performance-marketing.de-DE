...
Derzeit sind Mediendaten für DV360 und Innovid nicht verfügbar, was bedeutet, dass die Registerkarte Attribute auch für diese Kanäle nicht angezeigt wird. Die Registerkarte Attribute hängt von den Daten der Medienebene ab, um die aus den Erlebnissen extrahierten Merkmale zu ermitteln.
...
Die Ansicht [[!DNL Insights] _[!UICONTROL Anzeigen ]_Tags](ad-tags.md) zeigt eine Liste der Anzeigen für das verbundene Kanal-Werbekonto an. Eine_ Anzeige _ist ein Werbeelement, das visuelle und interaktive Inhalte enthält, die im Rahmen einer Marketing-Kampagne an eine bestimmte Zielgruppe verteilt werden sollen.
