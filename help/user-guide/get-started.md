...
description: Erfahren Sie, wie Sie mit GenStudio for Performance Marketing beginnen können, um markenkonforme Marketing-Inhalte zu generieren und das Kampagnen-Management zu beschleunigen.
level: Beginner
role: User
...
Wenn Sie mit auf generativer KI basierenden Tools noch nicht vertraut oder einfach nur neugierig auf die Kernprinzipien von GenStudio for Performance Marketing sind, finden Sie weitere Informationen unter [Konzepte](/help/user-guide/concepts.md) und [Schreiben effektiver Prompts](/help/user-guide/effective-prompts.md). In der [Adobe GenStudio Academy](https://learningmanager.adobe.com/genstudioacademy), der Online-Lernplattform von Adobe, finden Sie Informationen zur Verwendung generativer KI-Technologien im Kreativprozess.
...
Bevor Sie Richtlinien erstellen, informieren Sie sich darüber, wie in GenStudio for Performance Marketing [Markenkomponenten](/help/user-guide/guidelines/brands.md) definiert werden.
