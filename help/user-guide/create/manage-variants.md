...
![Abschnitte neu erstellen](/help/assets/regenerate-sections.png){width="300" zoomable="yes"}
...
1. Klicken Sie nach dem Erzeugen eines Variantensatzes auf **[!UICONTROL Seitenverhältnis-Größe]** (Pfeil, der auf die Ecke des Feldes zeigt) auf der linken Seite der Arbeitsfläche.
...
Sie können in Ihren Varianten einen Link zu Text, Bildern und CTA-Schaltflächen hinzufügen. Die Vorlage, die Sie zum Generieren von Varianten verwendet haben _muss_ einen [Inhalts-Platzhalter für den Link](/help/user-guide/templates/customize-template.md#content-placeholders) enthalten, um diese Funktion zu aktivieren.
...
Das Generations-Feedback gilt für eine einzelne Variante, nicht für den erfassten Variantensatz.
