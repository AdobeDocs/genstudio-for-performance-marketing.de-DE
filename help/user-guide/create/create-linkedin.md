...
1. Wählen Sie _Abschnitt_ Parameter“ Richtlinien - [!DNL Brands], [!DNL Personas] und [!DNL Products] - aus, um über die Inhaltserstellung zu informieren.
   ...
   ![Persona auswählen](/help/assets/persona-select-linkedin2.png){width="50%" align="center"}
...
2. [Varianten manuell überarbeiten](#revise-generated-linkedin-ads) um sicherzustellen, dass Ihre Varianten eng mit den dann abgeschlossenen Inhaltsprüfungen abgestimmt sind.
