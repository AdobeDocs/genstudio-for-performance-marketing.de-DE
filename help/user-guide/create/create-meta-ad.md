...
In diesem Tutorial wird gezeigt, wie Sie mit GenStudio for Performance Marketing [[!DNL Create]](/help/user-guide/create/overview.md) (](/help/user-guide/create/meta-experiences.md) im linken Navigationsbereich) Meta-Anzeigen-Erlebnisse mit Branding generieren können.[

Informationen zum Erstellen einer Karussellanzeige mit mehreren Karten anstelle einer einzelnen Bild- oder Videoanzeige finden Sie unter [Erstellen eines Meta-Karussellanzeigenerlebnisses](/help/user-guide/create/create-meta-carousel-ad.md).
...
Verwenden Sie eine verfügbare Vorlage, um das Framework für Ihre Inhalte bereitzustellen, um mit der Erstellung eines neuen Meta-Anzeigenerlebnisses zu beginnen. Informationen zu den unterstützten Seitenverhältnissen für Meta](/help/user-guide/templates/meta-template.md)Anzeigenvorlagen finden Sie unter [Richtlinien für Meta-Anzeigenvorlagen .
...
1. Wählen Sie _Abschnitt_ Parameter“ Richtlinien - [!DNL Brands], [!DNL Personas] und [!DNL Products] - aus, um über die Inhaltserstellung zu informieren.
   ...
   ![Persona auswählen](/help/assets/persona-select-meta2.png){width="50%" align="center"}
...
2. [Varianten manuell überarbeiten](#revise-generated-variants) um sicherzustellen, dass Ihre Varianten eng mit den durchgeführten Inhaltsprüfungen abgestimmt sind.
