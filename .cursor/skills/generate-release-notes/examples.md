...
---
# Beispiele für Versionshinweise

Einfügefertige Muster für [help/user-guide/release-notes.md](../../help/user-guide/release-notes.md). Ton und Struktur auf die umgebende Datei abstimmen.

## Beispiel für eine minimale Schriftart (nur auf neuer Seite)

Nur verwenden **wenn eine neue** von Grund auf neu erstellt wird. Wenn die Datei bereits vorhanden ist, behalten Sie stattdessen die vollständige Frontanzeige bei.
...
## Funktionsabschnitt (Dokumentations-Link in Prosa)
...
## Fehlerbehebungen und Verbesserungen (Aufzählungszeichen)
...
Verwenden Sie diesen Unterabschnitt nur für Elemente **explizit** mit der Beschriftung Korrektur oder Verbesserung im Quellmaterial.

## Archivierter Block (frühere Versionshinweise)
